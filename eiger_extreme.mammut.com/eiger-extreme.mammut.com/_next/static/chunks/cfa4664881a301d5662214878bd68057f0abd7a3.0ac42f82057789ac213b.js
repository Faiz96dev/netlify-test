    ...
    [2], {
        ...
        elyg: function(t, e, r) {
            ...
            var n = r("zoAU"),
                ...
                i = r("/GRZ"),
                u = r("i2R6");
            e.__esModule = !0, e.addLocale = w, e.delLocale = _, e.hasBasePath = x, e.addBasePath = S, e.delBasePath = P, e.isLocalURL = k, e.interpolateAs = R, e.resolveHref = O, e.markLoadingError = j, e.default = void 0;
            var c = r("X24+"),
                s = r("wkBG"),
                l = m(r("dZ6Y")),
                f = r("g/15"),
                ...
                return u(t, [{
                    ...
                    value: function() {
                        var e = a(o.mark((function e(r, n, a, i) {
                            var u, s, l, d, g, m, b, S, O, L, j, C, A, I, T, U, N, q, D, W, M, G, F, H, V;
                            return o.wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 3:
                                        if (i._h || (this.isSsr = !1), f.ST && performance.mark("routeChange"), this._inFlightRoute && this.abortComponentLoad(this._inFlightRoute), a = w(a, this.locale, this.defaultLocale), u = _(x(a) ? P(a) : a, this.locale), this._inFlightRoute = a, i._h || !this.onlyAHashChange(u)) {
                                            e.next = 17;
                                            break
                                        }
                                    ...
                                    case 22:
                                        if (l = e.sent, l.__rewrites, d = (0, p.parseRelativeUrl)(n), m = (g = d).pathname, b = g.query, (d = this._resolveHref(d, s)).pathname !== m && (m = d.pathname, n = (0, f.formatWithValidation)(d)), m = m ? (0, c.removePathTrailingSlash)(P(m)) : m, this.urlIsNew(u) || (r = "replaceState"), S = (0, c.removePathTrailingSlash)(m), O = i.shallow, L = void 0 !== O && O, j = _(P(j = a), this.locale), !(0, h.isDynamicRoute)(S)) {
                                            e.next = 50;
                                            break
                                        }
                                        if (C = (0, p.parseRelativeUrl)(j), A = C.pathname, I = (0, y.getRouteRegex)(S), T = (0, v.getRouteMatcher)(I)(A), N = (U = S === A) ? R(S, A, b) : {}, T && (!U || N.result)) {
                                            e.next = 49;
                                            break
                                        }
                                        if (!((q = Object.keys(I.groups).filter((function(t) {
                                                return !b[t]
                                            }))).length > 0)) {
                                            e.next = 47;
                                            break
                                        }
                                        throw new Error((U ? "The provided `href` (".concat(n, ") value is missing query values (").concat(q.join(", "), ") to be interpolated properly. ") : "The provided `as` value (".concat(A, ") is incompatible with the `href` value (").concat(S, "). ")) + "Read more: https://err.sh/vercel/next.js/".concat(U ? "href-interpolation-failed" : "incompatible-href-as"));
                                    case 47:
                                        e.next = 50;
                                        break;
                                    case 49:
                                        U ? a = (0, f.formatWithValidation)(Object.assign({}, C, {
                                            pathname: N.result,
                                            query: E(b, N.params)
                                        })) : Object.assign(b, T);
                                    case 50:
                                        return t.events.emit("routeChangeStart", a), e.prev = 51, e.next = 54, this.getRouteInfo(S, m, b, a, L);
                                    case 54:
                                        if (D = e.sent, W = D.error, M = D.props, G = D.__N_SSG, F = D.__N_SSP, !((G || F) && M && M.pageProps && M.pageProps.__N_REDIRECT)) {
                                            e.next = 65;
                                            break
                                        }
                                        if (!(H = M.pageProps.__N_REDIRECT).startsWith("/")) {
                                            e.next = 63;
                                            break
                                        }
                                        if (V = (0, p.parseRelativeUrl)(H), this._resolveHref(V, s), !s.includes(V.pathname)) {
                                            e.next = 63;
                                            break
                                        }
                                        return e.abrupt("return", this.change("replaceState", H, H, i));
                                    case 63:
                                        return window.location.href = H, e.abrupt("return", new Promise((function() {})));
                                    case 65:
                                        return t.events.emit("beforeHistoryChange", a), this.changeState(r, n, w(a, this.locale, this.defaultLocale), i), e.next = 70, this.set(S, m, b, u, D).catch((function(t) {
                        ...
                        var e = a(o.mark((function e(r, n, a, i, u) {
                            ...
                            return o.wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 9:
                                        return c = e.sent, s = c.page, l = c.styleSheets, f = {
                                            Component: s,
                                            styleSheets: l,
                                            err: r,
                                            error: r
                                    ...
                                    case 16:
                                        ...
                                        break;
                                    case 19:
                                        e.prev = 19, e.t0 = e.catch(13), console.error("Error in error page `getInitialProps`: ", e.t0), f.props = {};
                                    case 23:
